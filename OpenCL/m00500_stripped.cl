...
__kernel void m00500_init (__global pw_t *pws, __global md5crypt_tmp_t *tmps, __global const salt_t *salt_bufs, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u64 gid_max)
{
  /**
   * base
   */
...
__kernel void m00500_loop (__global pw_t *pws, __global md5crypt_tmp_t *tmps, __global const salt_t *salt_bufs, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u64 gid_max)
{
  /**
   * base
   */
...
__kernel void m00500_comp (__global pw_t *pws, __global md5crypt_tmp_t *tmps, __global const salt_t *salt_bufs, const u32 salt_pos, const u32 loop_pos, const u32 loop_cnt, const u64 gid_max)
{
  /**
   * modifier
   */
